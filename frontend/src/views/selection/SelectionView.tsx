        ...
        <div className="flex flex-col items-center space-y-8">
            ...
            <div className="flex space-x-8">
                <div className="flex flex-col items-center">
                    <Image src={personaImage} alt="Persona Natural" width={100} height={100} />
                    <button className="w-full bg-red-700 text-yellow-500 border-none py-2 mt-2 rounded hover:bg-red-800 text-lg" onClick={handleRegister}>
                        Persona Natural
                    </button>
                </div>
                <div className="flex flex-col items-center">
                    <Image src={restauranteImage} alt="Restaurante" width={100} height={100} />
